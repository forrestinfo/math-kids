...
export const DIFFICULTY_LABELS: Record<Difficulty, string> = {
  ...
  DIVIDE_5: '除5速算',
  COMPENSATE_ADD: '凑整加法',
  COMPENSATE_SUBTRACT: '凑整减法',
  MULTIPLY_DISTRIBUTIVE: '乘法分配律',
  NEAR_100_MULTIPLY: '接近100乘法',
  PERCENTAGE_QUICK: '百分比速算',
  FRACTION_CONVERT: '分数转换',
  SQUARE_DIFFERENCE: '平方差公式',
  MULTIPLE_FEATURES: '倍数特征',
